...
export default function RegistrationForm() {
  ...
  const nextStep = () => {
    ...
    if (step === 1 && (!formData.teamName || !formData.collegeName)) {
      setErrorMsg("Please fill in team name and college name to proceed.");
      return;
    }
    setErrorMsg("");
    setDirection(1);
            ...
            <div>
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input type="tel" name="leaderPhone" className="form-input" value={formData.leaderPhone} onChange={handleChange} required />
                </div>
              </div>
              <div className="form-group">
                <label className="form-label">Email Address *</label>
                <input type="email" name="leaderEmail" className="form-input" value={formData.leaderEmail} onChange={handleChange} required />
              </div>
            </div>
          )}
          ...
          {step === 5 && (
            <div>
              ...
              <div style={{ padding: '20px', background: 'var(--bg-glass)', borderRadius: '12px', border: '1px solid var(--glass-border)', marginBottom: '30px' }}>
                ...
                <p style={{ textAlign: 'center', fontWeight: 'bold', letterSpacing: '1px' }}>NAVYA SRI S D</p>
              </div>
